...
public class Barang1 extends javax.swing.JFrame {
    public static int harga1 = 4000000;
    public static String barang1 = "Poco X3 Pro 8/256 GB";

    public static int getHarga1() {
    ...
    private void initComponents() {
        ...
        lgambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/barang poco.jpg"))); // NOI18N
